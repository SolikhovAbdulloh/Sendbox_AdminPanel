          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-3">
              ...
              >
                ...
                <p className="text-sm font-medium mb-1">Drag and drop your signature file here or click to browse</p>
                <p className="text-xs text-muted-foreground">
                  Supports YARA (.yar, .yara), Suricata (.rules, .rule), and Regex (.regex, .txt) files
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-3">
              ...
              <Textarea
                ...
                placeholder="Enter a description for this signature"
                value={description}
            ...
            <div className="grid gap-3">
              ...
              {signatureType === "YARA" && (
                <p className="text-xs text-muted-foreground">
                  Example: rule ExampleRule {`{`} strings: $a = "suspicious string" condition: $a {`}`}
                </p>
              )}
            </div>
          </CardContent>
