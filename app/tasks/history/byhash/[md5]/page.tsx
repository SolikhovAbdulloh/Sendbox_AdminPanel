...
export default function ApkTaskDetailsPage({ params }: { params: Promise<{ md5: string }> }) {
  ...
  const {
    ...
    url: `1/cape/tasks/history/byhash/${hash}`,
  ...
  return (
    <DashboardLayout>
      <div className="mb-4 flex items-center justify-between">
        ...
        <Button onClick={() => downloadFile(hash)}>
